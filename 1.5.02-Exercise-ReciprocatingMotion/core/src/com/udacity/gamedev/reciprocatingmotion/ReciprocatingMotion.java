...
public class ReciprocatingMotion extends ApplicationAdapter {
    ...
    private static final float CYCLE_TIME = 4;
    ...
    public void render() {
        ...
        float x = worldCenterX + MOVEMENT_DISTANCE * MathUtils.sin(2*MathUtils.PI*cyclePosition);
